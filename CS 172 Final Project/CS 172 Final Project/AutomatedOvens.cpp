...
{
	upgrades->push_back(new Upgrade(0, 1, 0, 0.55, 0, 1, 250, 1, "Maintennce Guy", 200000, "He reduces the risk factor of your Adamantium Automated Ovens but slightly increases overhead(He's a journeyman)"));
    upgrades->push_back(new Upgrade(6000, 1, 0, 1, 0, 1, 300, 1, "Cookie Almost-Perfection Sensor", 300000, "increase overall cookie production by 700 cookies, but increases cost of production"));
	upgrades->push_back(new Upgrade(0, 1, 4, 1, 0, 1.35, 150, 1, "Cookie Perfection Detecting Owner Eye Implant", 500000,
		"Increases the sell price of cookies by 4, but increases the risk factor and slightly increase production cost"));
	upgrades->push_back(new Upgrade(0, 1.4, 3, 1, 0, 1, 0, 1.02, "Electric Ovens", 700000, "Ovens are electric which increases production but also slightly increases risk factor and and overhead"));
	upgrades->push_back(new Upgrade(0, 0.25, 0, 1.05, 0, 1.1, 0, 1, "Rotational Turntable", 850000, "Turntable that evenly heats the cookies. Slightly increases cookie sell price but slightly decreases production and increases risk factor."));
	...
	upgrades->push_back(new Upgrade(0, 1, -2, 1, 0, 1.55, 11250, 1, "Cookie Perfection Detecting Bakers Eye Implant", 37500000, "increases cookie sell price and decreases risk factor but it largely increases overhead"));
